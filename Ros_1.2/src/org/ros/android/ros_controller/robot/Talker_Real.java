 ...
 *
 */
public class Talker_Real extends AbstractNodeMain{
	...
	public void onStart(final ConnectedNode connectedNode) 
	{
		...
		publisher_bounding_box=connectedNode.newPublisher("string_bounding_box", std_msgs.String._TYPE);
	}
	...
	public String publish_bounding_box(int[] boundingPoints){
	...
	public void publish_arm_command(int command_num){
