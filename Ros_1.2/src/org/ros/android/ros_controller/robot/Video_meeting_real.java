 ...
 *
 */
public class Video_meeting_real extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        image.setTopicName("RAW_LIMAGE/compressed");//"wide_stereo/left/image_color/compressed"			///usb_cam/image_raw/compressed
